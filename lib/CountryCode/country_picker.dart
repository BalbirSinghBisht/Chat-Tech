...
class CountryPicker extends StatefulWidget {
  CountryPicker({required this.callBackFunction, required this.headerText,
...
class _CountryPickerState extends State<CountryPicker> {
  ...
  void didChangeDependencies() async {
    if (widget.isInit) {
      ...
      widget.callBackFunction(selectedCountryData.name, selectedCountryData.dialCode);
    }
                  ...
                  ...tmpList.map(
                    (item) => GestureDetector(
                      onTap: () {
                        ...
                        widget.callBackFunction(item.name, item.dialCode);
                      },
                      child: Padding(
...
//country model
class CountryModel {
  const CountryModel({required this.name, required this.dialCode, required this.code});

  factory CountryModel.fromJson(Map<String, dynamic> json) {
    return CountryModel(
        name: json['name'] as String, dialCode: json['dial_code'] as String, code: json['code'] as String);
  }

  final String name, dialCode, code;
